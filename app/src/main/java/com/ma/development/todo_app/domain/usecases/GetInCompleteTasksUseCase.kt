...
class GetInCompleteTasksUseCase @Inject constructor(private val taskRepository: TaskRepository){

    fun execute () : LiveData<List<Task>> = taskRepository.getInCompleteTasks()
